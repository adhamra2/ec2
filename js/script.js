...
const productInfo2 = document.getElementById("product2-info");
const productinfobtn2 = document.getElementById("productinfobtn2")

function showProduct2 () {
    productInfo2.style.display = "block"
}

productinfobtn2.addEventListener("click", showProduct2) ;   
